class ProjectsController < ApplicationController
  ...
  def project_param
    params.require(:project).permit(:name, :domain, :date_started, :no_of_sprints, :price_per_sprint, :quotation_no, :notes, :pivotal_project_id, :client_id, :date_completed, coder_ids: [])
  end
end
